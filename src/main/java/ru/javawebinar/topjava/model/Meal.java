...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.ALL_BETWEENDATES, query = "SELECT m FROM Meal m WHERE m.user.id=:user_id " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_BETWEENDATES = "Meal.getAllBetweenDates";
