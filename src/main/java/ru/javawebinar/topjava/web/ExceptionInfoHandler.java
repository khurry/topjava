...
//@ControllerAdvice(assignableTypes = ProfileUIController.class)
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        ...
        else if (rootCause.contains("date_time"))
            return logAndGetErrorInfo(req, e, true, VALIDATION_ERROR, "Meal with this date already exists");
