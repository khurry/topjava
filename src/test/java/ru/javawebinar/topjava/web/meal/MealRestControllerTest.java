...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    private static final int DEFAULT_CALORIES_PER_DAY = MealsUtil.DEFAULT_CALORIES_PER_DAY;
    private static final int DEFAULT_USER_ID = SecurityUtil.authUserId();
    ...
    void delete() throws Exception {
        ...
        assertThrows(NotFoundException.class, () -> mealService.get(MEAL1_ID, DEFAULT_USER_ID));
    }
    ...
    void update() throws Exception{
        ...
        MEAL_MATCHER.assertMatch(mealService.get(MEAL1_ID, DEFAULT_USER_ID), updated);
    }
    ...
    void createWithLocation() throws Exception {
        ...
        MEAL_MATCHER.assertMatch(mealService.get(newId, DEFAULT_USER_ID), newMeal);
    }
